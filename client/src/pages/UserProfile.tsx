  ...
  return (
    <div className='container mx-auto px-8 mt-24'>
      <div className='flex justify-center items-center'>
        <div className='flex flex-col my-4 p-12 lg:w-2/5 bg-light-100 dark:bg-primaryDark border shadow-md rounded hover:shadow-lg dark:shadow-xl hover:dark:shadow-2xl active:shadow-inner border-opacity-50 active:border-opacity-100 transition justify-center items-center'>
