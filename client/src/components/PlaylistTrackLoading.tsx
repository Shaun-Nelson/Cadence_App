      ...
      >
        <div className='mb-12'>
          <div className='flex items-center'>
            <div className='h-28 mr-10 bg-gray-300 w-1/6 rounded-full'></div>
            <div className='h-4 mr-10 bg-gray-300 w-1/5 rounded-3xl'></div>
            <div className='h-4 mr-8 bg-gray-300 w-1/6 rounded-3xl'></div>
            <div className='h-4 mr-8 bg-gray-300 w-1/6 rounded-3xl'></div>
            <div className='h-4 mr-8 bg-gray-300 w-1/12 rounded-3xl'></div>
            <div className='h-12 bg-gray-300 w-1/3 rounded-3xl'></div>
          </div>
        </div>
        <div className='mb-12'>
          <div className='flex items-center'>
