...
const NavBar = () => {
  ...
  return (
    <nav className='sticky top-0 w-full p-1 lg:p-0 shadow bg-light-100 dark:bg-dark-500 z-50'>
        ...
        <li>
          <Link to='/'>
            <img
              src={logo}
              alt='Cadence Logo'
              className='h-14 transition lg:hover:scale-125 active:scale-50 active:shadow-inner cursor-pointer text-secondayDark hover:text-primaryDark dark:text-secondaryLight dark:hover:text-primaryLight'
            />
          </Link>
        </li>
